...
exports.SalesOrderInvoiceRequestStockItems = sequelize.define('sales_order_invoice_request_stock_items',{
...
exports.Timelines = sequelize.define('timelines',{
                    ...
                    content_type:{type:Sequelize.ENUM('employee_visit_photos', 'employee_visit_before_after_photos','employee_visit_notes')},
                    user_id:{type:Sequelize.INTEGER},
                    visit_id:{type:Sequelize.INTEGER},
                    employee_id:{type:Sequelize.INTEGER},
                    customer_id:{type:Sequelize.INTEGER},
...
exports.GalleryTimelines = sequelize.define('gallery_timelines',{
                    content_id:{type:Sequelize.INTEGER},
                    content_type:{type:Sequelize.ENUM('employee_visit_photos', 'employee_visit_before_after_photos')},
                    user_id:{type:Sequelize.INTEGER},
                    visit_id:{type:Sequelize.INTEGER},
                    employee_id:{type:Sequelize.INTEGER},
                    customer_id:{type:Sequelize.INTEGER},
...
exports.SurveyAssignToCustomers = sequelize.define('survey_assign_to_customers',{
                    survey_id:{type:Sequelize.INTEGER},
                    customer_id:{type:Sequelize.INTEGER},
...
exports.EmployeeTargetCategoryCustomers = sequelize.define('employee_target_category_customers',{
                                                employee_id:{type:Sequelize.INTEGER},
                                                category_id:{type:Sequelize.INTEGER},
...
exports.EmployeeSentAccountStatements = sequelize.define('employee_sent_account_statements',{
                                            user_id:{type:Sequelize.INTEGER},
                                            employee_id:{type:Sequelize.INTEGER},
                                            customer_id:{type:Sequelize.INTEGER},
                                            email:{type:Sequelize.STRING},
